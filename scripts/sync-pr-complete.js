...
async function syncPRPOData() {
  ...
  try {
    console.log('🔄 เริ่มการซิงค์ข้อมูล PR-PO (Schema v2.0 - Complete)...\n');
    ...
    console.log(`✓ ดึงข้อมูลได้ ${records.length.toLocaleString()} รายการ\n`);
    ...
    console.log(`  - PR Master: ${jsonData.pr_master.length.toLocaleString()} รายการ`);
    console.log(`  - PR Lines: ${jsonData.pr_lines.length.toLocaleString()} รายการ`);
    console.log(`  - PO Links: ${jsonData.pr_po_links.length.toLocaleString()} รายการ\n`);
    ...
    console.log(`  - PR Master: ${result_data.pr_master_updated.toLocaleString()} รายการ`);
    console.log(`  - PR Lines: ${result_data.pr_lines_updated.toLocaleString()} รายการ`);
    console.log(`  - PO Links: ${result_data.po_links_updated.toLocaleString()} รายการ`);
    ...
    console.log('  - SELECT * FROM vw_po_summary;           -- สรุป PO');
